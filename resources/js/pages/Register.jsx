...
export default function Register() {
    ...
    return (
        <div className="max-w-sm mx-auto py-8">
            <h1 className="text-xl font-semibold text-center mb-6">Buat Akun Baru</h1>
            ...
            <form onSubmit={handleSubmit} className="bg-white border border-stone-200 rounded-xl p-6 space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full border border-stone-300 rounded-md px-3 py-2 text-sm"
                    />
                    <p className="text-xs text-stone-400 mt-1">Minimal 8 karakter.</p>
                </div>
                <div>
            ...
            <p className="text-center text-sm text-stone-500 mt-4">
                Sudah punya akun?{' '}
                <Link to="/login" className="text-amber-600 font-medium hover:underline">Masuk di sini</Link>
            </p>
        </div>
    )
}
